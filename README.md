...
| Neo4j service container | Claimed when workflow succeeds | The Neo4j proof starts a `neo4j:5.26-community` service container, writes graph data, and runs Cypher path traversal on a hosted runner. |
